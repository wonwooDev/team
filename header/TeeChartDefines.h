...
const unsigned long laKorean = 24;
const unsigned long laIndonesian = 25;
const unsigned long laFinnish = 26;
const unsigned long laSlovak = 27;
const unsigned long laHellenic = 28;
const unsigned long laRomanian = 29;
const unsigned long laSerbian = 30;
const unsigned long laFarsi = 31;
const unsigned long laCzech = 32;
const unsigned long laHindi = 33;
const unsigned long laUrdu = 34;
const unsigned long laMalaysian = 35;
const unsigned long laCroatian = 36;
const unsigned long laBulgarian = 37;
